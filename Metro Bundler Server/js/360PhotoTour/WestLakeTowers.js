  ...
  _getInfoControls() {
    return (
      <ViroNode
        ...
        <InfoElement content={slutWindowCard} contentCardScale={[3.67,1,0]} position={polarToCartesian([-5, 0, 30])}/>
        <InfoElement content={monorailInfoCard} contentCardScale={[3.67,1,1]} position={polarToCartesian([-5, 80, 20])}/>
        <InfoElement content={statueWindowCard} contentCardScale={[3,1,1]} position={polarToCartesian([-5, 75, 0])}/>
        <ViroImage
          scale={[1, 1, 1]}
          position={[0, -3.5, 0]}
          rotation={[-90, 0, 0]}
